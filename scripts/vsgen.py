...
with open('Thretris.sln', 'w') as sln:
	sln.writelines([
		'Microsoft Visual Studio Solution File, Format Version 12.00\n',
		'# Visual Studio Version 17\n',
		'VisualStudioVersion = 17.10.35013.160\n',
		'MinimumVisualStudioVersion = 10.0.40219.1\n',
		'Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "Thretris", "Thretris.vcxproj", "{A3DB4047-E0C5-4756-B9BB-6CBFCA3B593C}"\n',
		'EndProject\n',
		'Global\n',
...
inc_lines = []
src_lines = []
for dir in ['src', 'include', 'subprojects/cacaoengine']:
...
with open('Thretris.vcxproj', 'w') as vcx:
	all_lines = [
		[
		...
		'    <NMakeOutput>$(Configuration)\\ThretrisBundle\\Thretris.exe</NMakeOutput>\n',
